...
'''
# i guess above is an alternative to pound sign.


name = "Nandaa" 	#here name is a string
print(name * 3)     #here it will now print the NandaaNandaaNandaa 

name = 30			#here name is an integer
print(name * 3)     #here output will be 90.

name = str(name)	#here name is type-casted to a string from integer
print(name * 3) #here output should be 303030
